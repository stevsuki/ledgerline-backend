...
const docTemplate = `{
        ...
        "/transactions/overview": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Month to report, as YYYY-MM. Defaults to the current month",
                        "name": "month",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/github_com_stevensuki_ledgerline-backend_internal_delivery_http_dto.TransactionOverviewResponseDTO"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "type": "string",
                        "description": "weekly (the weeks of this month) or monthly (the last six months)",
                        "name": "range",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/github_com_stevensuki_ledgerline-backend_internal_delivery_http_dto.TransactionTrendResponseDTO"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "github_com_stevensuki_ledgerline-backend_internal_delivery_http_dto.CategorySpendResponseDTO": {
            "type": "object",
            "properties": {
                "category_id": {
                    "type": "string",
        ...
        "github_com_stevensuki_ledgerline-backend_internal_delivery_http_dto.TransactionOverviewResponseDTO": {
            "type": "object",
            "properties": {
                "base_currency": {
                    "type": "string",
                ...
                "current": {
                    "$ref": "#/definitions/github_com_stevensuki_ledgerline-backend_internal_delivery_http_dto.TransactionPeriodResponseDTO"
                },
                "month": {
                    "type": "string",
                    "example": "2026-09"
        ...
        "github_com_stevensuki_ledgerline-backend_internal_delivery_http_dto.TransactionPeriodResponseDTO": {
            "type": "object",
            "properties": {
                "by_category": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_stevensuki_ledgerline-backend_internal_delivery_http_dto.CategorySpendResponseDTO"
                    }
                },
                "expense_entries": {
                    "type": "integer",
        ...
        "github_com_stevensuki_ledgerline-backend_internal_delivery_http_dto.TransactionTrendPointResponseDTO": {
            "type": "object",
            "properties": {
                "money_in": {
                    "type": "integer",
        ...
        "github_com_stevensuki_ledgerline-backend_internal_delivery_http_dto.TransactionTrendResponseDTO": {
            "type": "object",
            "properties": {
                "base_currency": {
                    "type": "string",
                ...
                "points": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_stevensuki_ledgerline-backend_internal_delivery_http_dto.TransactionTrendPointResponseDTO"
                    }
                },
                "range": {
                    "type": "string",
