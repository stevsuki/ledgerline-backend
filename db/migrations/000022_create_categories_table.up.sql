CREATE TABLE IF NOT EXISTS categories (
    ...
    master_category_id UUID         REFERENCES master_categories (id) ON DELETE SET NULL,
...
CREATE INDEX IF NOT EXISTS categories_user_id_idx ON categories (user_id, created_at ASC);
